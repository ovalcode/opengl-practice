...
//        vertexBuffer.position(0);
        ...
        int vertexShader = MySurfaceRenderer.loadShader(GLES20.GL_VERTEX_SHADER, vertexShaderCode);
        int fragmentShader = MySurfaceRenderer.loadShader(GLES20.GL_FRAGMENT_SHADER, fragmentShaderCode);
